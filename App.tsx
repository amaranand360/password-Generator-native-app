...
const PasswordSchema = Yup.object().shape({
  passwordLength: Yup.number()
    .min(4, 'Should be minimum of 4 char')
    .max(20, 'Should be minimum of 4 char')
...
const App = () => {
  ...
  const generatePasswordString = (passwordLength:
    ...
    const passwordOuput = createPassword(characterList, passwordLength)
    console.log(`Password output val ${passwordOuput}`)

    setPassword(passwordOuput);
    setIsPassGenerated(true);
  }

  const createPassword = (characters:
    string, passwordLength: number) => {
    let result = ''
    console.log("char len->",characters.length)
